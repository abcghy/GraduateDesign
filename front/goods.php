...
<div class="container">
    <div class="col-md-12">
        ...
        <div class="col-md-9">
            ...
            if (isset($_COOKIE['first_compare'])) {
            ?>
                <a href="compare.php?id=<?php echo $id;?>" type="button" class="btn btn-lg btn-info" style="margin-top: 15px">
    ...
    <ul class="col-md-8" style="list-style: none" >
        ...
        echo '</ul><img class="col-md-4" src="../dist/img/goods_1.png"/></div><h3 style="text-align: center">内饰及电器</h3><div class="col-md-12"><ul class="col-md-8" style="list-style: none" >';
        while ($part_row = $part_result->fetch_array()) {
            if ($detail_row['a'.$i] == '') {
                echo '<li class="col-md-4">';
                echo '<i class="fa fa-check"></i> ';
        ...
        echo '</ul><img class="col-md-4" src="../dist/img/goods_2.png"/></div><h3 style="text-align: center">底盘大梁</h3><div class="col-md-12"><ul class="col-md-8" style="list-style: none" >';
        while ($part_row = $part_result->fetch_array()) {
            if ($detail_row['a'.$i] == '') {
                echo '<li class="col-md-4">';
                echo '<i class="fa fa-check"></i> ';
        ...
        echo '</ul><img class="col-md-4" src="../dist/img/goods_3.png"/></div><h3 style="text-align: center">外观</h3><div class="col-md-12"><ul class="col-md-8" style="list-style: none" >';
        while ($part_row = $part_result->fetch_array()) {
            if ($detail_row['a'.$i] == '') {
                echo '<li class="col-md-4">';
                echo '<i class="fa fa-check"></i> ';
        ...
        echo '</ul><img class="col-md-4" src="../dist/img/goods_4.png"/></div><h3 style="text-align: center">其他</h3><div class="col-md-12"><ul class="col-md-12" style="list-style: none" >';
        while ($part_row = $part_result->fetch_array()) {
            if ($detail_row['a'.$i] == '') {
