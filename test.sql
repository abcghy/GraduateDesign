...
insert into user(email, password, nickname, rate) values ('123@qq.com', '123', '123', 0);
insert into user(email, password, nickname, rate) values ('234@qq.com', '234', '123', 0);
insert into user(email, password, nickname, rate) values ('123@hotmail.com', '123', '123', 0);
insert into user(email, password, nickname, rate) values ('234@hotmail.com', '234', '123', 0);
insert into user(email, password, nickname, rate) values ('beatbox_gao@hotmail.com', '19941024Abc', 'Gao', 0);
...
insert into car (model, type, price, year, mile, fixed, title, description, user) values (62, 4, 665800, 2015, 6300, 0, "保时捷 2015年款 Cayman 2.7T 时尚版", "X2.7T自动涡轮增压。 出售2015年6月上牌保时捷，2.7V6发动机，电动车窗，电动调节后视镜，自动调节空调，自动大灯，大灯清洗装置，倒车雷达，真皮坐椅，前排电动座椅，前排座椅电加热，多安全气囊。公里数少，车主当时加装十几万，类似新车。。本公司购车可贷款，不限年限，利率低。您所购买的任何车型均可享受（发动机、变速箱、差速器、涡轮增压器、冷却系统、制动系统、电气系统、转向系统）质保1年（不限地区），本车经过车易拍268V行认证， 让您买的称心，用的放心.", 4);
